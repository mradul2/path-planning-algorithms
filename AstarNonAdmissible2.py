...
def AstarNonAdmissible2(matrix):
    ...
    while not PQ.empty():
        ...
        for neig in neighbours1(current,matrix):
            ...
            if tempGscore < neig.g:
                neig.parent = current
                neig.g = tempGscore
                neig.f = neig.g + manhattan(neig, end) * 2
...
cv2.namedWindow("AstarNonAdmissible2")
cv2.imshow("AstarNonAdmissible2",IMAGE)
cv2.waitKey(0)