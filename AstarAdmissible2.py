    ...
    while not PQ.empty():
        ...
        for neig in neighbours1(current,matrix):
            ...
            if tempGscore < neig.g:
                neig.parent = current
                neig.g = tempGscore
                neig.f = neig.g + euclidean(neig,end) / 1.5
...
cv2.namedWindow("AstarAdmissible2")
cv2.imshow("AstarAdmissible2",IMAGE)
cv2.waitKey(0)
